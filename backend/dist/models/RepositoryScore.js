...
exports.RepositoryScore = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const scoreWithRiskSchema = new mongoose_1.Schema({
    score: { type: Number, required: true },
    riskLevel: { type: String, enum: ['LOW', 'MEDIUM', 'HIGH', 'CRITICAL'], required: true },
    breakdown: { type: mongoose_1.Schema.Types.Mixed, required: true },
    recommendations: { type: [String], required: true, default: [] },
}, { _id: false });
const repositoryScoreSchema = new mongoose_1.Schema({
...
exports.RepositoryScore = mongoose_1.default.model('RepositoryScore', repositoryScoreSchema);
//# sourceMappingURL=RepositoryScore.js.map