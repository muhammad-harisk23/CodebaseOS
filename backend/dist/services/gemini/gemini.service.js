...
class GeminiService {
    ...
    constructor() {
        if (!env_1.env.geminiApiKey) {
            logger_1.logger.warn('GEMINI_API_KEY not set - Gemini features will be disabled');
        }
        this.genAI = new generative_ai_1.GoogleGenerativeAI(env_1.env.geminiApiKey || 'dummy-key');
     ...
     */
    async generateRepositorySummary(repositoryName, metadata) {
...
5. Maintenance Considerations`;
     ...
     */
    async generateArchitectureSummary(repositoryName, metadata) {
...
5. Architecture Diagram Description`;
     ...
     * Generate README
     */
    async generateReadme(repositoryName, metadata, summary) {
...
8. License`;
     ...
     */
    async generateDocumentation(type, repositoryName, metadata) {
...
Provide comprehensive, well-structured Markdown documentation.`;
     ...
     */
    async generateLearningMissions(repositoryName, metadata) {
...
Format as JSON array.`;
     ...
     */
    async generateInterviewQuestions(repositoryName, metadata) {
...
Format as JSON with: question, category, correctAnswer.`;
     ...
     */
    async generateAgentRecommendations(scores, risks) {
...
Format as actionable items with priority levels.`;
    ...
    getFallbackResponse(prompt) {
        logger_1.logger.info('Using fallback response generation (Gemini API not configured)');
...
> Generated by CodebaseOS Documentation Engine`;
    ...
    generateFallbackMissions(prompt) {
        const missions = [
            {
    ...
    generateFallbackQuestions(prompt) {
        const questions = [
...
Generated by CodebaseOS Agent Engine. Configure GEMINI_API_KEY for AI-powered recommendations.`;
    ...
    generateFallbackDocumentation(prompt) {
